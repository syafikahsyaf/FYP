  ...
  const start = async () => {
    try {
      ...
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: "/FYP/assets/targets/proseskitar/Pkaca1.mind",
      });
      ...
      ====================== */
      const targets = [
         { glb:"/FYP/assets/models/Mproseskitar/Kaca1.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkaca1.mp3", scale:0.2, info:"Semua botol dan balang kaca dikumpul. Kaca dipisahkan mengikut warna dan dibersihkan." },
        { glb:"/FYP/assets/models/Mproseskitar/Pkaca2.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkaca2.mp3", scale:0.2, info:"Botol dihancurkan jadi kepingan kecil dipanggil cullet." },
        { glb:"/FYP/assets/models/Mproseskitar/Pkaca3.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkaca3.mp3", scale:0.18, info:"Cullet dimasukkan ke dalam relau panas. Ia mula cair dan menjadi cecair kaca berkilau." },
        { glb:"/FYP/assets/models/Mproseskitar/Pkaca4.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkaca4.mp3", scale:0.18, info:"Cecair kaca tadi dituang ke dalam acuan. Perlahan-lahan ia membentuk benda baru seperti botol dan produk lain." },
        { glb:"/FYP/assets/models/Mproseskitar/Pkaca5.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkaca5.mp3", scale:0.18, info:"Dari kaca lama kita dapat pasu baru, cawan kaca dan macam-macam lagi. Kaca sangat istimewa kerana boleh dikitar berkali-kali tanpa rosak." }
