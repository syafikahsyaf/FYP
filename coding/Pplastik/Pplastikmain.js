...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    try {
      ...
      ====================== */
      const targets = [
        { glb:"/FYP/assets/models/Mproseskitar/Pplastik1.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Splastik1.mp3", scale:0.10, info:"Semua botol dan bekas plastik dikumpulkan dan dipisahkan mengikut jenisnya." },
        { glb:"/FYP/assets/models/Mproseskitar/Pplastik2.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Splastik2.mp3", scale:0.10, info:"Plastik dibasuh untuk membuang kotoran, label dan sisa makanan." },
        { glb:"/FYP/assets/models/Mproseskitar/Pplastik3.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Splastik3.mp3", scale:0.10, info:"Selepas bersih, plastik dipotong menjadi serpihan kecil." },
        { glb:"/FYP/assets/models/Mproseskitar/Pplastik4.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Splastik4.mp3", scale:0.10, info:"Serpihan plastik dipanaskan sehingga cair dan dibentuk menjadi pellet." },
        { glb:"/FYP/assets/models/Mproseskitar/Pplastik5.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Splastik5.mp3", scale:0.10, info:"Pellet tadi boleh digunakan untuk menghasilkan kerusi, baldi, bekas baru dan banyak lagi." }
