  ...
  const start = async () => {
    try {
      ...
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: "/FYP/assets/targets/tongkitar/tongoren2.mind",
      });
      ...
      ====================== */
      const targets = [
       { glb: "/FYP/assets/models/Mtongkitar/plastlogmain.glb", audioMain: "/FYP/assets/suara/Stongkitar/tjingga1.mp3", scale: 0.2, info: "Tong jingga sesuai untuk sampah jenis plastik dan logam" },
        { glb: "/FYP/assets/models/Mtongkitar/Lplas1.glb", audioMain: "/FYP/assets/suara/Stongkitar/tjingga2.mp3", scale: 0.2, info: "Bahan plastik dan logam yang boleh dikitar semula adalah seperti Tapau plastik, botol jus plastik, tin makanan dan tin aerosol kosong." },
        { glb: "/FYP/assets/models/Mtongkitar/Lplas2.glb", audioMain: "/FYP/assets/suara/Stongkitar/tjingga3.mp3", scale: 0.18, info: "Bahan plastik dan logam yang tak boleh kitar semula adalah seperti polisterin, paip PVC, tong cat logam dan bateri" }
