  ...
  const start = async () => {
    try {
      ...
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: "/FYP/assets/targets/tongkitar/tongcoklat3.mind",
      });
      ...
      ====================== */
      const targets = [
        { glb: "/FYP/assets/models/Mtongkitar/kacamain.glb", audioMain: "/FYP/assets/suara/Stongkitar/tcoklat1.mp3", scale: 0.2, info: "Tong coklat sesuai untuk sampah jenis kaca" },
        { glb: "/FYP/assets/models/Mtongkitar/kaca1.glb", audioMain: "/FYP/assets/suara/Stongkitar/tcoklat2.mp3", scale: 0.2, info: "Bahan kaca yang boleh dikitar semula adalah Balang kaca, botol kaca dan gelas kaca" },
        { glb: "/FYP/assets/models/Mtongkitar/kaca2.glb", audioMain: "/FYP/assets/suara/Stongkitar/tcoklat3.mp3", scale: 0.18, info: "Bahan kaca yang tak boleh kitar semula adalah seperti mentol lampu, cermin dan mangkuk seramik" }
      ];
      ...
      /* =====================
         TAP AUDIO + ROTATE (SAMA DGN CODING 1)
      ====================== */
