...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    try {
      ...
      ====================== */
      const targets = [
        { glb:"/FYP/assets/models/Mproseskitar/Pkertas1.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkertas1.mp3", scale:0.2, info:"Semua kertas lama seperti surat khabar, buku dan kotak dikumpulkan. Kemudian, dipisahkan mengikut jenisnya.Kertas lama dihancurkan jadi cebisan kecil." },
        { glb:"/FYP/assets/models/Mproseskitar/Pkertas2.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkertas2.mp3", scale:0.2, info:" Cebisan tadi dimasukkan dalam larutan air khas dan berubah menjadi pulpa iaitu bubur kertas lembut yang boleh dibentuk semula." },
        { glb:"/FYP/assets/models/Mproseskitar/Pkertas3.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkertas3.mp3", scale:0.18, info:" Sebelum menjadi kertas baru, pulpa perlu dibersihkan dahulu. Ia ditapis untuk membuang plastik kecil, dakwat dan kotoran lain." },
        { glb:"/FYP/assets/models/Mproseskitar/Pkertas4.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkertas4.mp3", scale:0.18, info:"Pulpa diratakan,ditekan dan dikeringkan.Bubur kertas perlahan-lahan keras menjadi helaian." },
        { glb:"/FYP/assets/models/Mproseskitar/Pkertas5.glb", audioMain:"/FYP/assets/suara/Sproseskitar/Spkertas5.mp3", scale:0.18, info:"Kertas lama kini menjadi barang baru seperti buku dan kotak tisu." }
